...
public class CodeGenerator {
    ...
    private static final String dataUrl = "jdbc:mysql://localhost:3306/blog_db?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&characterSetResults=utf8";
    private static final String driverName = "com.mysql.jdbc.Driver";
    private static final String parentPackage = "com.blog";
    ...
    public static void main(String[] args) {
        ...
        // 当前工程路径
        String projectPath = "E:\\IDEAworkpasce\\SpringBoot-Result\\Blog";
